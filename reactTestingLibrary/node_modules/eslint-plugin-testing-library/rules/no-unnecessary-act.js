...
exports.default = create_testing_library_rule_1.createTestingLibraryRule({
    ...
    create(context, [options], helpers) {
        function getStatementIdentifier(statement) {
            ...
            if (!callExpression &&
                !node_utils_1.isExpressionStatement(statement) &&
                !node_utils_1.isReturnStatement(statement)) {
                return null;
            }
            if (callExpression) {
                return node_utils_1.getDeepestIdentifierNode(callExpression);
            }
            if (node_utils_1.isExpressionStatement(statement) &&
                experimental_utils_1.ASTUtils.isAwaitExpression(statement.expression)) {
                return node_utils_1.getPropertyIdentifierNode(statement.expression.argument);
            }
            if (node_utils_1.isReturnStatement(statement) && statement.argument) {
                return node_utils_1.getPropertyIdentifierNode(statement.argument);
            }
            return null;
        }
