...
const isVariableDeclaration = (node) => {
    if (node_utils_1.isCallExpression(node.parent) &&
    ...
    if (node_utils_1.isMemberExpression(node.parent) &&
        node_utils_1.isCallExpression(node.parent.parent) &&
        ...
        return {
            ...
            'Program:exit'() {
                findQueryCalls.forEach((queryCall) => {
                    const memberExpression = node_utils_1.isMemberExpression(queryCall.parent)
                        ? queryCall.parent
                        : queryCall;
